...
def seed_test_data():
    ...
    if not ItemModel.find_by_id(1):
        ...
        items.append(UsageModel(1, UsageTypeEnum(UsageTypeEnum.KILOWATT), 5, '127.0.0.1:5000/item/1', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('staande_lamp_1', '127.0.0.1:5000/item/2', 'staande lamp = beste lamp'))
        items.append(UsageModel(2, UsageTypeEnum(UsageTypeEnum.KILOWATT), 1, '127.0.0.1:5000/item/2', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('staande_lamp_2', '127.0.0.1:5000/item/3', 'staande lamp = beste lamp'))
        items.append(UsageModel(3, UsageTypeEnum(UsageTypeEnum.KILOWATT), 1, '127.0.0.1:5000/item/3', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('slaapkamer_verlichting', '127.0.0.1:5000/item/4', 'verlichting in de slaapkamer'))
        items.append(UsageModel(4, UsageTypeEnum(UsageTypeEnum.KILOWATT), 1, '127.0.0.1:5000/item/4', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('lamp_nachtkastje', '127.0.0.1:5000/item/5', 'lamp op nachtkastje'))
        items.append(UsageModel(5, UsageTypeEnum(UsageTypeEnum.KILOWATT), 1, '127.0.0.1:5000/item/5', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('toilet', '127.0.0.1:5000/item/6', 'toilet in badkamer'))
        items.append(UsageModel(6, UsageTypeEnum(UsageTypeEnum.WATER_PER_USAGE), 9, '127.0.0.1:5000/item/6', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('douche', '127.0.0.1:5000/item/7', 'douche'))
        items.append(UsageModel(7, UsageTypeEnum(UsageTypeEnum.WATER_PER_HOUR), 9, '127.0.0.1:5000/item/7', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('vaatwasser', '127.0.0.1:5000/item/8', ''))
        items.append(UsageModel(8, UsageTypeEnum(UsageTypeEnum.WATER_PER_USAGE), 10, '127.0.0.1:5000/item/8', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('wasmachine', '127.0.0.1:5000/item/9', ''))
        items.append(UsageModel(9, UsageTypeEnum(UsageTypeEnum.WATER_PER_USAGE), 13, '127.0.0.1:5000/item/9', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('droger', '127.0.0.1:5000/item/10', ''))
        items.append(UsageModel(10, UsageTypeEnum(UsageTypeEnum.KILOWATT), 9, '127.0.0.1:5000/item/10', UnitEnum(UnitEnum.TOGGLE), 0, 1))

        items.append(ItemModel('badkamer verlichting', '127.0.0.1:5000/item/11', ''))
        items.append(UsageModel(11, UsageTypeEnum(UsageTypeEnum.KILOWATT), 1, '127.0.0.1:5000/item/11', UnitEnum(UnitEnum.TOGGLE), 0, 1))
